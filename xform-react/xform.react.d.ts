...
export declare class ItemValue extends Base {
  ...
  static runEnabledConditionsForItems(
    items: Array<ItemValue>,
    runner: ConditionRunner,
    values: any,
    properties: any
...
export declare class JsonObjectProperty implements IObject {
  ...
  readonly hasToUseSetValue:
    | string
    | ((obj: any, value: any, jsonConv: JsonObject) => any);
...
export declare class MatrixDropdownRowModelBase
 ...
 */
export declare class QuestionMatrixDropdownModelBase extends QuestionMatrixBaseModel<
 ...
 */
export declare class QuestionMatrixDropdownModel extends QuestionMatrixDropdownModelBase
  implements IMatrixDropdownData {
  name: string;
  constructor(name: string);
  getType(): string;
 ...
 */
export declare class QuestionMatrixDynamicModel extends QuestionMatrixDropdownModelBase
  implements IMatrixDropdownData {
  name: string;
 ...
 */
export declare class QuestionMatrixModel extends QuestionMatrixBaseModel<
  MatrixRowModel,
  ItemValue
...
export declare class MultipleTextItemModel extends Base
 ...
 */
export declare class QuestionMultipleTextModel extends Question
 ...
 */
export declare class PanelModelBase extends SurveyElement
 ...
 */
export declare class Question extends SurveyElement
...
export declare class QuestionFileModel extends Question {
   ...
   */
  removeFile(content: {name: string}): void;
  /**
...
export declare class QuestionPanelDynamicItem
 ...
 */
export declare class QuestionPanelDynamicModel extends Question
 ...
 */
export declare class SurveyModel extends Base
  implements ISurvey, ISurveyData, ISurveyImpl, ISurveyTriggerOwner, ILocalizableOwner {
  [index: string]: any;
   ...
   */
  getPlainData(options?: {includeEmpty?: boolean}): any[];
  getFilteredValues(): any;
  getFilteredProperties(): any;
...
export declare class dxSurveyService {
  ...
  getSurveyJsonAndIsCompleted(
    surveyId: string,
    clientId: string,
    onLoad: (success: boolean, surveyJson: any, result: string, response: any) => void
  ): void;
  sendResult(
    postId: string,
    result: JSON,
