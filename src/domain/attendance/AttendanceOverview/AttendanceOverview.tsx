...
<a href="/plugins/xformation-petclinic-panel/page/markattendance">Edit Attendance</a>
                        </span></td>
                        <td></td>
                        <td><span className="btn btn-success hasTooltip"><i className="fa fa-check" aria-hidden="true"></i> Marked
<a href="/plugins/xformation-petclinic-panel/page/markattendance">Edit Attendance</a>
...
<a className="tooltip-red" href="/plugins/xformation-petclinic-panel/page/markattendance">Take Attendance</a>
                        </span></td>
                        <td></td>
                        <td><span className="btn btn-success hasTooltip"><i className="fa fa-check" aria-hidden="true"></i> Marked
                        <a href="/plugins/xformation-petclinic-panel/page/markattendance">Edit Attendance</a>
